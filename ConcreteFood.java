...
public class ConcreteFood implements Food{
	...
	*	in turn contain the attributes of a food that will be passed into the ConcreteMenuItems
	...
	*
	*/
	public ConcreteFood(String name, boolean taste, String vat, String price){
